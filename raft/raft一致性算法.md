...
![E904B1DA-D26A-47A0-8215-4BEE5AF10C15](/Users/lichenyi/go/src/lcy/markdownImage/raft/E904B1DA-D26A-47A0-8215-4BEE5AF10C15.png)

因此可以看出，raft算法的核心在于对选取leader节点这一操作进行限制，从而大幅降低问题复杂度。相较于复杂的paxos算法，我们能够非常轻松的基于raft算法实现一致的分布式系统。

顺便介绍一个便于理解raft的小工具：http://thesecretlivesofdata.com/raft/